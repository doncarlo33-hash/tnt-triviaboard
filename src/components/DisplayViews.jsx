...
export function SocialMediaView() {
  return (
    <section className="social-media-full-view">
      ...
      <div className="social-media-grid" style={{ display: 'flex', flexWrap: 'wrap', gap: '5vw', marginTop: '4vh', justifyContent: 'center' }}>
        <div className="social-qr-wrap" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" style={{ height: 'clamp(40px, 6vh, 80px)', fill: 'white', marginBottom: '2vh' }}>
          ...
          <img src="/qr-facebook.png" alt="Scan to find us on Facebook" style={{ width: 'clamp(200px, 35vw, 500px)', height: 'clamp(200px, 35vw, 500px)', objectFit: 'contain', borderRadius: 'clamp(16px, 3vw, 32px)', boxShadow: '0 16px 64px rgba(0,0,0,0.6)' }} />
        </div>
        <div className="social-qr-wrap" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style={{ height: 'clamp(40px, 6vh, 80px)', fill: 'white', marginBottom: '2vh' }}>
          ...
          <img src="/qr-instagram.png" alt="Scan to find us on Instagram" style={{ width: 'clamp(200px, 35vw, 500px)', height: 'clamp(200px, 35vw, 500px)', objectFit: 'contain', borderRadius: 'clamp(16px, 3vw, 32px)', boxShadow: '0 16px 64px rgba(0,0,0,0.6)' }} />
        </div>
      </div>
    </section>
  );
