...
export default React.memo(function ScoreboardPanel({ teams, setState, updateState, currentCategoryIndex, fullscreen = false }) {
  return (
...
function TeamRowComponent({ team, rankIndex, currentCategoryIndex, setState, updateState }) {
  return (
    <tr>
